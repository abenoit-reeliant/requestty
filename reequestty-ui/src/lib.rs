...
//!
//! While this crate was built for the  [`reequestty`] crate and other crates which implement the
//! [`Prompt`] trait in [`reequestty`], it can be used otherwise as well.
//!
//! [`reequestty`]: https://crates.io/crates/reequestty
//! [`Prompt`]: https://docs.rs/reequestty/latest/reequestty/prompt/trait.Prompt.html
//!
//! # Backends
//!
